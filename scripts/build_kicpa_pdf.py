...
def build():
    ...
    callout(
        ...
        "세무조정 금액·과세표준·세액을 확정하고, 사내 로컬 AI가 애매한 분개의 "
    ...
    table(
        ...
        [
            ...
            ["구현 방식", "로컬 실행 프로그램(브라우저 화면) · 법령 규칙 자동계산 엔진 · 보조 AI(선택)"],
        ],
        widths=[26, 114])
    ...
    body(pdf,
         ...
         "음수 표기(△·괄호·전각), 합계행, 회사별 계정명 차이를 표준화 정리 과정이 하나의 관문에서 흡수합니다. "
