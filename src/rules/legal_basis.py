...
ADJUSTMENT_LEGAL_BASIS: dict[str, tuple[str, str, str]] = {
    ...
    "stock_compensation_excess": ("조세특례제한법 제13조의2 (주식매수선택권 등 비용)", LAW_SPECIAL_TAX,     "001302"),
    "construction_revenue_add":  ("법인세법 시행령 제69조 (용역제공 등에 의한 손익의 귀속사업연도)", LAW_CORP_TAX_DECREE, "006900"),
    "treasury_stock_loss_disallowed": ("법인세법 제15조·제17조 (자기주식처분손익 자본거래)", LAW_CORP_TAX, "001700"),
    "proper_purpose_reserve_excess": ("법인세법 제29조 (고유목적사업준비금의 손금산입)", LAW_CORP_TAX, "002900"),
    ...
    "construction_revenue_excluded": ("법인세법 시행령 제69조 (작업진행률 수익인식 차이)", LAW_CORP_TAX_DECREE, "006900"),
    "treasury_stock_gain_excluded": ("법인세법 제17조 (자본거래 수익의 익금불산입)", LAW_CORP_TAX, "001700"),
    "proper_purpose_reserve_deduction": ("법인세법 제29조 (고유목적사업준비금의 손금산입)", LAW_CORP_TAX, "002900"),
    # ── 세액 (산출세액 이후) ──
